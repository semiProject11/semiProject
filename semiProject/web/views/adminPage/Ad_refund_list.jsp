...
<jsp:include page="../common/menubar2.jsp" />	
 ...
 <!--contents-->
            <div class="container mt-5">
				...
				<div class="page-center">
					<ul class="pagination-t">
  						...
  						<li class="page-item-t disabled-t"><a class="page-link-t" href="<%if (currentPage != 1) {%><%=request.getContextPath() %>/list.refund?currentPage=<%=currentPage-1 %><%}%>">Previous</a></li>
			...
			<%} %>
						...
						<li class="page-item-t"><a class="page-link-t" href="<%if (currentPage != endPage) {%><%=request.getContextPath() %>/list.refund?currentPage=<%=currentPage+1%><%}%>">Next</a></li>
