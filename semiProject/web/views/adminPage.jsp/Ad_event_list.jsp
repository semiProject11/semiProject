                ...
                <div class="container my-4">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn" style="background:black; color:white; width:95px;"><a
                                href="admin_event_write.html" id="wh">글쓰기</a></button>
                        <button type="button" class="btn" style="background:black; color:white; width:95px;">삭
                            제</button>
                        <!--상단 검색창-->
                        <form
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td> <a href="admin_event_read.html" id="bk">BTS와 함께하는 5월 이벤트 </a></td>
                                    <td>2020-05-01</td>
