                        ...
                        <div class="sb-sidenav-menu-heading">
                            ...
                            <div class="collapse" id="collapseNotice" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link"
                                        href="admin_notice.html">공지사항 관리</a><a class="nav-link"
                                        href="admin_event.html">이벤트 관리</a></nav>
                            </div>
                    </div>
                </div>
            ...
            <div class="container mt-5">
                ...
                <div class="container my-4">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn" style="background:black; color:white">등급 변경</button>
                        <button type="button" class="btn" style="background:black; color:white">구매자 제한</button>
                        <button type="button" class="btn" style="background:black; color:white">판매자 제한</button>
                        <!--상단 검색창-->
                        <form
