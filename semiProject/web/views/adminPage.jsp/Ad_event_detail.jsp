                    ...
                    <div class="container mt-5">
                        <div class="container my-5">
                            <form class="form-group">
                                <div class="row">
                                    <div class="col-md-2"><label>Ï†úÎ™©</label></div>
                                    <div class="col-md-10"><label class="form-control"
                                            style="width:100%; text-align:left;">BTSÏôÄ Ìï®ÍªòÌïòÎäî 5Ïõî Ïù¥Î≤§Ìä∏</label></div>
                                </div>
>>>>>>> refs/remotes/origin/master
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseUsers"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="admin_grade.html">∆«∏≈¿⁄ µÓ±ﬁ ∞¸∏Æ</a> <a
									class="nav-link" href="admin_transaction.html">∞≈∑°≥ªø™ ∞¸∏Æ</a> <a
									class="nav-link" href="admin_review.html">¿¸√º ∏Æ∫‰ ∞¸∏Æ</a> <a
									class="nav-link" href="admin_inquiry.html">πÆ¿« ªÁ«◊ ∞¸∏Æ</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapseReport"
							aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="admin_report.html">Ω≈∞Ì ≥ªø™ ∞¸∏Æ</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapsePoints"
							aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="admin_point.html">∆˜¿Œ∆Æ ∞¸∏Æ</a><a
									class="nav-link" href="admin_refund.html">»Ø∫“ ∞¸∏Æ</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapseNotice"
							aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="admin_notice.html">∞¯¡ˆªÁ«◊ ∞¸∏Æ</a><a
									class="nav-link" href="admin_event.html">¿Ã∫•∆Æ ∞¸∏Æ</a>
							</nav>
						</div>
					</div>
				</div>
							...
							<form class="form-group">
								<div class="row">
									...
									<div class="col-md-10">
										<label class="form-control"
											style="width: 100%; text-align: left;">BTSøÕ «‘≤≤«œ¥¬ 5ø˘
											¿Ã∫•∆Æ</label>
									</div>
								</div>
								...
								<div class="mt-2">
									<textarea class="form-control"
										style="width: 100%; height: 500px; resize: none; align-items: left;">æ»≥Á«œººø‰~ ≈∏¿”ºø∑Ø¿‘¥œ¥Ÿ.
BTSøÕ¿« µ•¿Ã∆Æø° ¥ÁΩ≈¿ª √ ¥Î«’¥œ¥Ÿ!
                            </textarea>
								...
								<div class="row mt-3">
									...
									<div class="col text-center">
										<button type="button" class="btn"
											...
											<a href="admin_event.html" id="wh">∏Ò∑œ</a>
										</button>
										<button type="button" class="btn"
											style="background: black; color: white">ºˆ¡§</button>
