      ...
      <br>
        ...
        <br>
           <div class="form-check-inline" style="margin-left:300px ">
             <label >가능요일&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Monday">
               <label>월&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Tuesday">
               <label>화&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Wednesday">
               <label>수&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Thursday">
               <label>목&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Friday">
               <label>금&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Saturday">
               <label>토&nbsp;&nbsp;&nbsp;</label>
               <input class="form-check-input" type="checkbox" id="day" name="day" value="Sunday">
               <label>일</label>
