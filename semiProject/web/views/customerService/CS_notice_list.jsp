   	...
   	<!------페이징 처리----->
				<div class="page-center">
					<ul class="pagination-t">
  						...
  						<li class="page-item-t"><a class="page-link-t" href="<%if (currentPage != 1) {%><%=request.getContextPath() %>/list.notice?currentPage=<%=currentPage-1 %><%}%>">Previous</a></li>
			...
			<%} %>
						...
						<li class="page-item-t"><a class="page-link-t" href="<%if (currentPage != endPage) {%><%=request.getContextPath() %>/list.notice?currentPage=<%=currentPage+1%><%}%>">Next</a></li>
