...
public class Service implements Serializable{
	...
	public Service(int serviceNo, int s_user_no, String sale_info, String available_area, int readCount,
			int file_count, String file_YN, int b_user_no, String saleMethod, Date deadline, int price_bidding,
			int price_sale, String subject, String category_code) {
		this.serviceNo = serviceNo;
		this.s_user_no = s_user_no;
		this.sale_info = sale_info;
		this.available_area = available_area;
