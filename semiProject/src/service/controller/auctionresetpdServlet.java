...
/**
 * Servlet implementation class auctionresetpdServlet
 */
@WebServlet("/reset.service")
public class auctionresetpdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public auctionresetpdServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String category = request.getParameter("category");
		 ...
		 Service_Service svService = new Service_Service();
	      ...
	      ArrayList<CategoryListPd> svlist = svService.resetpd(category, salemethod);
