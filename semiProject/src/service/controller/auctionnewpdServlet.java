...
/**
 * Servlet implementation class auctionnewpdServlet
 */
@WebServlet("/newpd.service")
public class auctionnewpdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public auctionnewpdServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String category = request.getParameter("category");
		 ...
		 Service_Service svService = new Service_Service();
	      ...
	      ArrayList<CategoryListPd> svlist = svService.newpdsort(category, salemethod);
