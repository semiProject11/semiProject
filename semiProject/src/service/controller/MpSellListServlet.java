...
/**
 * Servlet implementation class MpSellListServlet
 */
@WebServlet("/sellList.sv")
public class MpSellListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MpSellListServlet() {
        super();
...
//				int listCount = sService.getBuyListCount(userNo);
				int listCount = sService.getSellListCount(userNo);
				//---------- 페이징 처리 추가 ----------------
