...
public class MemberDao {
	...
	public Member loginMember(Connection conn, Member member) {
		...
		try {
			...
			if (rset.next()) {
				loginUser = new Member(rset.getString("USER_NO"), rset.getString("USER_ID"), rset.getString("USER_PWD"),
		...
		try {
			...
			while (rset.next()) {
				...
				Member m = new Member(rset.getString("rnum"), 
						...
						rset.getString("grade"), rset.getInt("grade_Tot"), rset.getString("profile"),
						rset.getString("sell_YN"), rset.getString("Review_YN")
	...
	public ArrayList<Seller> selectSellerList(Connection conn, int currentPage, int limit) {
		...
		try {
			...
			while (rset.next()) {
				...
				Seller s = new Seller(rset.getInt("s_user_No"), rset.getInt("report_Num"), rset.getInt("sellCount")
	...
	public Member memberLogin(Connection conn, String userId) {
		...
		try {
			...
			if (rset.next()) {
				mem = new Member(rset.getString("USER_NO"), rset.getString("USER_ID"), rset.getString("USER_PWD"),
						rset.getString("USER_NAME"), rset.getString("BIRTH"), rset.getString("PHONE"),
						rset.getString("EMAIL"), rset.getInt("POINT"), rset.getDate("ENROLL_DATE"),
						rset.getDate("DROP_DATE"), rset.getString("STATUS"), rset.getString("GRADE"),
						rset.getInt("GRADE_TOT"), rset.getString("PROFILE"), rset.getString("SELL_YN"),
	...
	public Account selectAccount(Connection conn, String userNo) {
		...
		try {
			...
			if (rset.next()) {
				ac = new Account(rset.getString("BANK"), rset.getString("ACCOUNT_HOLD"), rset.getString("ACCOUNT"),
	...
	public ArrayList<Member> selectTradeS(Connection conn, int currentPage, int limit) {
		...
		try {
			...
			while (rset.next()) {
				...
				Member mem = new Member(rset.getString("S_USER_NO"), rset.getString("USER_ID"),
						rset.getString("USER_PWD"), rset.getString("USER_NAME"), rset.getString("BIRTH"),
						rset.getString("PHONE"), rset.getString("EMAIL"), rset.getInt("POINT"),
						rset.getDate("ENROLL_DATE"), rset.getDate("DROP_DATE"), rset.getString("STATUS"),
						rset.getString("GRADE"), rset.getInt("GRADE_TOT"), rset.getString("PROFILE"),
						rset.getString("SELL_YN"), rset.getString("REVIEW_YN"));
	...
	public ArrayList<Member> selectTradeB(Connection conn, int currentPage, int limit) {
		...
		try {
			...
			while (rset.next()) {
				...
				Member mem = new Member(rset.getString("B_USER_NO"), rset.getString("USER_ID"),
						rset.getString("USER_PWD"), rset.getString("USER_NAME"), rset.getString("BIRTH"),
						rset.getString("PHONE"), rset.getString("EMAIL"), rset.getInt("POINT"),
						rset.getDate("ENROLL_DATE"), rset.getDate("DROP_DATE"), rset.getString("STATUS"),
						rset.getString("GRADE"), rset.getInt("GRADE_TOT"), rset.getString("PROFILE"),
	...
	public Member selectTradeSel(Connection conn, int service_no) {
		...
		try {
			...
			if (rset.next()) {
				...
				seller = new Member(rset.getString("S_USER_NO"), rset.getString("USER_ID"), rset.getString("USER_PWD"),
						rset.getString("USER_NAME"), rset.getString("BIRTH"), rset.getString("PHONE"),
						rset.getString("EMAIL"), rset.getInt("POINT"), rset.getDate("ENROLL_DATE"),
						rset.getDate("DROP_DATE"), rset.getString("STATUS"), rset.getString("GRADE"),
						rset.getInt("GRADE_TOT"), rset.getString("PROFILE"), rset.getString("SELL_YN"),
	...
	public ArrayList<Member> searchMember(Connection conn, String word, int currentPage, int limit) {
		...
		if (word == "") {
			...
			try {
				...
				while (rset.next()) {
					Member m = new Member(rset.getString("USER_NO"), rset.getString("USER_ID"),
							rset.getString("USER_PWD"), rset.getString("USER_NAME"), rset.getString("BIRTH"),
							rset.getString("PHONE"), rset.getString("EMAIL"), rset.getInt("POINT"),
							rset.getDate("ENROLL_DATE"), rset.getDate("DROP_DATE"), rset.getString("STATUS"),
							rset.getString("GRADE"), rset.getInt("GRADE_TOT"), rset.getString("PROFILE"),
	...
	public Member selectSellerReview(Connection conn, int board_no) {
		...
		try {
			...
			if (rset.next()) {
				...
				seller = new Member(rset.getString("USER_NO"), rset.getString("USER_ID"), rset.getString("USER_PWD"),
						rset.getString("USER_NAME"), rset.getString("BIRTH"), rset.getString("PHONE"),
						rset.getString("EMAIL"), rset.getInt("POINT"), rset.getDate("ENROLL_DATE"),
						rset.getDate("DROP_DATE"), rset.getString("STATUS"), rset.getString("GRADE"),
						rset.getInt("GRADE_TOT"), rset.getString("PROFILE"), rset.getString("SELL_YN"),
		...
		try {
			...
			for (int i = 0; i < userNo.size(); i++) {
				...
				while (rset.next()) {
					...
					m = new Member(rset.getString("USER_NO"), rset.getString("USER_ID"), rset.getString("USER_PWD"),
							rset.getString("USER_NAME"), rset.getString("BIRTH"), rset.getString("PHONE"),
							rset.getString("EMAIL"), rset.getInt("POINT"), rset.getDate("ENROLL_DATE"),
							rset.getDate("DROP_DATE"), rset.getString("STATUS"), rset.getString("GRADE"),
							rset.getInt("GRADE_TOT"), rset.getString("PROFILE"), rset.getString("SELL_YN"),
	...
	public ArrayList<Member> searchPoint(Connection conn, int currentPage, int limit, String word) { // 아이디검색
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		ArrayList<Member> list = new ArrayList<>();
		int startRow = (currentPage - 1) * limit + 1;
		int endRow = currentPage * limit;
		System.out.println("쿼리 나오기전");
		//검색값이 있을때 
		String query = "select * from(select rownum rnum,q.* from(select * from member where status='Y' and USER_ID LIKE '%'||?||'%')q order by user_no desc) where rnum between ? and ?";
		
		  try { 
			  
			  System.out.println("쿼리나온 후");
			  pstmt=conn.prepareStatement(query); 
			  pstmt.setString(1, word);
			  pstmt.setInt(2,startRow); 
			  pstmt.setInt(3, endRow);
		 ...
		 while(rset.next()) {
		  ...
		  System.out.println("dao 담고나서:"+list);
		return list;
	}
	...
	public ArrayList<Member> searchTradeListS(Connection conn, int currentPage, int limit, String word, String type) {
		PreparedStatement pstmt=null;
	      ResultSet rset=null;
	...
	public ArrayList<Member> searchTradeListB(Connection conn, int currentPage, int limit, String word, String type) {
		PreparedStatement pstmt=null;
	      ResultSet rset=null;
	      ArrayList<Member> tradeList=new ArrayList<>();
	      int startRow = (currentPage-1) * limit + 1;
